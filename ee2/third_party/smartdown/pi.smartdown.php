...
class Smartdown {
	...
	/**
	 * The string returned by the plugin.
	 *
	 * @access	public
	 * @var 	string
	 */
	...
	/**
	 * PHP 4 constructor. Plugin won't work without it.
	 *
	 * @see		__construct
	 */
	...
	public function __construct($tagdata = '')
	{
		...
		if ($ee->TMPL->fetch_param('encode_ee_tags') == 'yes')
		{
			$tagdata = Markdown($ee->functions->encode_ee_tags($tagdata, TRUE));
		...
		// Apply SmartyPants.
		$smart_quotes = $ee->TMPL->fetch_param('smart_quotes') ? $ee->TMPL->fetch_param('smart_quotes') : '2';
...
/* File location	: /system/expressionengine/third_party/smartdown/pi.smartdown.php */
